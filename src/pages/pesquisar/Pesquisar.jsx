      ...
      <div className="home d-flex flex-column vh-100">
        <div className="bg-white shadow-sm">
          ...
          <div className="px-3 pb-3">
            <form>
              <div
                className="input-group rounded-4 shadow overflow-hidden border-0 py-1 ps-3 bg-light"
                style={{ marginTop: 15 }}
              >
                <span
          ...
          <div className="mb-3">
            ...
            <Slider {...availableDoctor} className="available-doctor ps-2 ms-1">
              <div className="available-doctor-item">
                <div
                  className="bg-primary text-white rounded-4 p-3 doctor-book-back"
                  style={{ width: 349 }}
                >
                  ...
                  <a
                    onClick={() => navigate("")}
                    className="btn btn-sm btn-dark btn-book"
                  >
