                  ...
                  <div className="nav-item-wrapper">
                    <span className="nav-item">
                      <div className="d-flex align-items-center gap-2">
                        <img
                          src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/favorite/favorite-4.jpg"
                          alt=""
                ...
                <li>
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      role="menuitem"
                    >
                      <span className="mdi mdi-cellphone me-3"></span>Splash{" "}
                    </a>
                  </div>
                </li>
                <li className="nav-parent">
                  ...
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      tabIndex="0"
                      role="menuitem"
                      aria-controls="menu-rwit2uq2ebk"
                      aria-haspopup="true"
                      aria-expanded="false"
                    >
                      <span className="mdi mdi-login me-3"></span>Authentication{" "}
                  ...
                  >
                    <div className="nav-content">
                      ...
                      <ul
                        ...
                        aria-labelledby="menu-rwit2uq2ebk"
                      >
                ...
                <li>
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      role="menuitem"
                    >
                      <span className="mdi mdi-bell-outline me-3"></span>
                      Notification{" "}
                    </a>
                  </div>
                </li>
                <li>
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      role="menuitem"
                    >
                      <span className="mdi mdi-home-variant-outline me-3"></span>
                      Homepage{" "}
                    </a>
                  </div>
                </li>
                <li className="nav-parent">
                  ...
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      tabIndex="0"
                      role="menuitem"
                      aria-controls="menu-pdl8lx20a4"
                      aria-haspopup="true"
                      aria-expanded="false"
                    >
                      <span className="mdi mdi-magnify me-3"></span>Doctors{" "}
                      <span className="nav-next"></span>
                    </a>
                  </div>
                  <div
                  ...
                  >
                    <div className="nav-content">
                      ...
                      <ul
                        ...
                        aria-level="2"
                        aria-label="Doctors"
                        aria-labelledby="menu-pdl8lx20a4"
                      >
                        <li className="nav-back">
                          <div className="nav-item-wrapper">
                            <a href="#" role="menuitem" tabIndex="0">
                        ...
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-magnify me-3"></span>
                              Doctor List{" "}
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-account-supervisor-outline me-3"></span>
                              Doctor Profile{" "}
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-calendar-check me-3"></span>
                              Request Appointment{" "}
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-calendar-plus me-3"></span>
                              Book Appointment{" "}
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-information-outline me-3"></span>
                              Visit Info{" "}
                            </a>
                          </div>
                        </li>
                ...
                <li className="nav-parent">
                  ...
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      tabIndex="0"
                      role="menuitem"
                      aria-controls="menu-qx3l4crx3l"
                      aria-haspopup="true"
                      aria-expanded="false"
                    >
                      <span className="mdi mdi-account-outline me-3"></span>My
                      Profile <span className="nav-next"></span>
                    </a>
                  </div>
                  <div
                    className="nav-wrapper nav-wrapper-1"
                  ...
                  >
                    <div className="nav-content">
                      ...
                      <ul
                        ...
                        aria-labelledby="menu-qx3l4crx3l"
                      >
                        <li className="nav-back">
                          <div className="nav-item-wrapper">
                            <a href="#" role="menuitem" tabIndex="0">
                        ...
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-account-outline me-3"></span>
                              My Account{" "}
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              href="my-appointment-upcoming.html"
                              className="nav-item"
                              tabIndex="0"
                              role="menuitem"
                            >
                              <span className="mdi mdi-calendar-clock me-3"></span>
                        ...
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-calendar-range me-3"></span>
                              My Appointments{" "}
                            </a>
                          </div>
                        </li>
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-history me-3"></span>
                              History{" "}
                            </a>
                          </div>
                        </li>
                        ...
                        <li>
                          <div className="nav-item-wrapper">
                            <a
                              ...
                              role="menuitem"
                            >
                              <span className="mdi mdi-square-edit-outline me-3"></span>
                              Edit Profile{" "}
                            </a>
                          </div>
                        </li>
                ...
                <li>
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      role="menuitem"
                    >
                      <span className="mdi mdi-video-outline me-3"></span>Video
                      Consultation{" "}
                    </a>
                  </div>
                </li>
                <li className="nav-parent">
                  ...
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      tabIndex="0"
                      role="menuitem"
                      aria-controls="menu-n0h2xppv5g"
                      aria-haspopup="true"
                      aria-expanded="false"
                    >
                      <span className="mdi mdi-phone-outline me-3"></span>Doctor
                      Call <span className="nav-next"></span>
                    </a>
                  </div>
                  <div
                    className="nav-wrapper nav-wrapper-1"
                  ...
                  >
                    <div className="nav-content">
                      ...
                      <ul
                        ...
                        aria-labelledby="menu-n0h2xppv5g"
                      >
                        <li className="nav-back">
                          <div className="nav-item-wrapper">
                            <a href="#" role="menuitem" tabIndex="0">
                ...
                <li className="nav-parent">
                  ...
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      tabIndex="0"
                      role="menuitem"
                      aria-controls="menu-nvrf2v10hx"
                      aria-haspopup="true"
                      aria-expanded="false"
                    >
                      <span className="mdi mdi-record-circle-outline me-3"></span>
                      Doctor Recordings <span className="nav-next"></span>
                    </a>
                  </div>
                  <div
                    className="nav-wrapper nav-wrapper-1"
                  ...
                  >
                    <div className="nav-content">
                      ...
                      <ul
                        role="menu"
                        aria-level="2"
                        aria-label="Doctor Recordings"
                        aria-labelledby="menu-nvrf2v10hx"
                      >
                        <li className="nav-back">
                          <div className="nav-item-wrapper">
                            <a href="#" role="menuitem" tabIndex="0">
                ...
                <li>
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      role="menuitem"
                    >
                      <span className="mdi mdi-message-processing-outline me-3"></span>
                      Message{" "}
                    </a>
                  </div>
                </li>
                <li>
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      role="menuitem"
                    >
                      <span className="mdi mdi-chat-processing-outline me-3"></span>
                      Chat{" "}
                    </a>
                  </div>
                </li>
                <li>
                  <div className="nav-item-wrapper">
                    <a
                      ...
                      role="menuitem"
                    >
                      <span className="mdi mdi-star-half-full me-3"></span>
                      Doctor Review{" "}
                    </a>
                  </div>
                </li>
        ...
        <div className="bg-white shadow-sm">
          <div className="d-flex align-items-center justify-content-between mb-auto p-3 osahan-header">
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              <a
                className="toggle bg-white shadow rounded-circle icon d-flex align-items-center justify-content-center hc-nav-trigger hc-nav-1"
                href="#"
                role="button"
            ...
            <Slider {...settings} className="available-doctor ps-2 ms-1">
              <div class="bg-primary text-white rounded-4 p-3 doctor-book-back">
                ...
                <div class="doctor-book-img">
                  <img
                    src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/home/available-doctor-1.png"
                    alt=""
                    class="img-fluid"
                  />
                </div>
            ...
            <div className="row row-cols-4 g-2">
              <div className="col">
                <div className="bg-white text-center rounded-4 p-2 shadow-sm">
                  <a href="search.html" className="link-dark">
                    <img
                      src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/home/doctor.png"
                      alt=""
              ...
              <div className="col">
                <div className="bg-white text-center rounded-4 p-2 shadow-sm">
                  <a href="request-appointment.html" className="link-dark">
                    <img
                      src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/home/schedule.png"
                      alt=""
                      className="img-fluid px-2"
                    />
              ...
              <div className="col">
                <div className="bg-white text-center rounded-4 p-2 shadow-sm">
                  <a href="search.html" className="link-dark">
                    <img
                      src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/home/prescription.png"
                      alt=""
                      className="img-fluid px-2"
                    />
              ...
              <div className="col">
                <div className="bg-white text-center rounded-4 p-2 shadow-sm">
                  <a href="search.html" className="link-dark">
                    <img
                      src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/home/medicine.png"
                      alt=""
                      className="img-fluid px-2"
                    />
            ...
            <Slider {...settingsDoctor} className="top-doctors ps-2 ms-1">
              <div>
                <a href="book-appointment.html" className="link-dark">
                  <div className="card bg-white border-0 rounded-4 shadow-sm overflow-hidden">
                    <img
                      src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/home/top-doctor-1.jpg"
              ...
              <div>
                <a href="book-appointment.html" className="link-dark">
                  <div className="card bg-white border-0 rounded-4 shadow-sm overflow-hidden">
                    <img
                      src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/home/top-doctor-2.jpg"
                      className="card-img-top top-doctor-img"
                      alt="..."
                    />
                    <div className="card-body small p-3 osahan-card-body">
              ...
              <div>
                <a href="book-appointment.html" className="link-dark">
                  <div className="card bg-white border-0 rounded-4 shadow-sm overflow-hidden">
                    <img
                      src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/home/top-doctor-3.jpg"
                      className="card-img-top top-doctor-img"
                      alt="..."
                    />
                    <div className="card-body small p-3 osahan-card-body">
            ...
            <div className="row row-cols-2 g-3">
              <div className="col">
                <div className="card rounded-4 border-0 position-relative shadow-sm overflow-hidden">
                  ...
                  <img
                    src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/video/available-doctor-1.jpg"
                    alt=""
                    className="card-img-top top-doctor-img"
                  />
                  <div className="card-body small p-3 osahan-card-body">
                    ...
                    <h6 className="mb-0">
                      $199{" "}
                      <span className="text-muted small ms-1">Inc.VAT</span>
                    </h6>
                  </div>
              ...
              <div className="col">
                <div className="card rounded-4 border-0 position-relative shadow-sm overflow-hidden">
                  ...
                  <img
                    src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/video/available-doctor-2.jpg"
                    alt=""
                    className="card-img-top top-doctor-img"
                  />
                  <div className="card-body small p-3 osahan-card-body">
              ...
              <div className="col">
                <div className="card rounded-4 border-0 position-relative shadow-sm overflow-hidden">
                  <img
                    src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/video/available-doctor-3.jpg"
                    alt=""
                    className="card-img-top top-doctor-img"
                  />
                  <div className="card-body small p-3 osahan-card-body">
              ...
              <div className="col">
                <div className="card rounded-4 border-0 position-relative shadow-sm overflow-hidden">
                  ...
                  <img
                    src="https://appdoutoroficial.github.io/appdoutor-pessoas/img/video/available-doctor-4.jpg"
                    alt=""
                    className="card-img-top top-doctor-img"
                  />
                  <div className="card-body small p-3 osahan-card-body">
        ...
        <ul className="second-nav">
          ...
          <li>
            <a href="notification.html">
              <span className="mdi mdi-bell-outline me-3"></span>Notification{" "}
            </a>
          </li>
          <li>
            <a href="home.html">
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="search.html">
                  <span className="mdi mdi-magnify me-3"></span>Doctor List{" "}
                </a>
              </li>
              <li>
                <a href="doctor-profile.html">
              ...
              <li>
                <a href="request-appointment.html">
                  <span className="mdi mdi-calendar-check me-3"></span>Request
                  Appointment{" "}
                </a>
              </li>
              <li>
                <a href="book-appointment.html">
                  <span className="mdi mdi-calendar-plus me-3"></span>Book
                  Appointment{" "}
                </a>
              </li>
              <li>
          ...
          <li>
            <a href="#">
              <span className="mdi mdi-account-outline me-3"></span>My Profile{" "}
            </a>
            <ul>
              <li>
              ...
              <li>
                <a href="my-appointment-upcoming.html">
                  <span className="mdi mdi-calendar-clock me-3"></span>My
                  Upcoming Appointment{" "}
                </a>
              </li>
              <li>
                <a href="my-appointment.html">
                  <span className="mdi mdi-calendar-range me-3"></span>My
                  Appointments{" "}
                </a>
              </li>
              <li>
                <a href="history.html">
                  <span className="mdi mdi-history me-3"></span>History{" "}
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="change-profile.html">
                  <span className="mdi mdi-square-edit-outline me-3"></span>Edit
                  Profile{" "}
                </a>
              </li>
            </ul>
          ...
          <li>
            <a href="#">
              <span className="mdi mdi-phone-outline me-3"></span>Doctor Call{" "}
            </a>
            <ul>
              <li>
          ...
          <li>
            <a href="#">
              <span className="mdi mdi-record-circle-outline me-3"></span>Doctor
              Recordings{" "}
            </a>
            <ul>
              <li>
          ...
          <li>
            <a href="review.html">
              <span className="mdi mdi-star-half-full me-3"></span>Doctor Review{" "}
            </a>
          </li>
        </ul>
