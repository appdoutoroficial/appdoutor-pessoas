...
const IniciarConsulta = () => {
  ...
  <div className="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
    ...
    <h6 className="mb-0 ms-3 me-auto fw-bold">Minha consulta</h6>
    <div className="d-flex align-items-center gap-3">
      <a
        className="toggle d-flex align-items-center justify-content-center fs-5 bg-white shadow rounded-circle icon"
        href="#"
      >
  ...
  <div className="vh-100 my-auto overflow-auto body-fix-osahan-footer">
    ...
    <div className="p-3">
      ...
      {/* patient info */}
      <div className="bg-white rounded-4 border p-3 mb-2">
        <p className="mb-2 fs-14 fw-bold text-black">Informações do paciente</p>
        <div className="d-flex align-items-center gap-4">
          <div>
      ...
      <div className="bg-white rounded-4 border p-3 mb-3">
        <p className="mb-2 fs-14 fw-bold text-black">Informação de pagamento</p>
        <div className="d-flex align-items-center gap-4">
          <div>
  ...
  <div className="footer mt-auto p-3 fix-osahan-footer">
    <div className="d-flex align-items-center justify-content-between rounded-4 shadow overflow-hidden bottom-nav-main">
      <a href="/inicio" className="col footer-bottom-nav">
      ...
      <a href="/perfil" className="col footer-bottom-nav active">
