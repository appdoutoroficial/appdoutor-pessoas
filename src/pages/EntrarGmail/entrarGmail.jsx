  ...
  return (
    <div className="sign-in-email p-4">
      <div className="card bg-transparent border-0">
        <img src="img/explore.svg" alt="" className="card-img-top mb-5" />
        <div className="card-body px-0">
          ...
          >
            <i className="bi bi-envelope-fill h5 me-2 mb-0" />
            Continuar com Gmail
          </a>
        </div>
      </div>
